 ...
 */
?>
<div <?php echo get_block_wrapper_attributes( array( 'class' => 'hero' ) ) ?>>
	<!-- replace this demo code with your own: -->
	<?php echo $args[ 'content' ] !== '' ? $args[ 'content' ] : 'this is the hero for the top of the page'; ?>
</div>